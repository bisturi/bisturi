...
if __name__ == '__main__':
   ...
   message_low_payload = Ethernet()
   message_low_payload.unpack(raw_message_low_payload)

   message_high_level_payload = Ethernet()
   message_high_level_payload.unpack(raw_message_high_level_payload)
